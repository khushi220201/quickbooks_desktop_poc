...
const username: string = process.env.QB_USERNAME || 'username';
const password: string = process.env.QB_PASSWORD || 'password';
...
webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.serverVersion = function (args: any, callback: any) {
...
webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.clientVersion = function (args: any, callback: any) {
    console.log('2 from web-service: ');

    let retVal: string = '';
    const qbwcVersion: string = args.strVersion.split('.')[0] + '.' +
...
webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.authenticate = function (args: any, callback: any) {
...
webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.sendRequestXML = function (args: any, callback: any) {
...
webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.receiveResponseXML = function (args: any, callback: any) {
...
webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.connectionError = function (args: any, callback: any) {
...
webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.getLastError = function (args: any, callback: any) {
...
webService.QBWebConnectorSvc.QBWebConnectorSvcSoap.closeConnection = function (args: any, callback: any) {
